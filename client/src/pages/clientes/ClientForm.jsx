...
export default function ClientsForm() {
  ...
  const checkEmail = async (email) => {
    try {
      const response = await fetch(`apismovilconstru.onrender.com/checkEmail/${email}/${params.id}`, {
        method: 'GET',
        headers: {
  ...
  const checkDoc = async (tipoDoc, cedula) => {
    try {
      const response = await fetch(`apismovilconstru.onrender.com/checkDoc/${cedula}/${tipoDoc}/${params.id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        }
