...
*/
-- DropForeignKey
ALTER TABLE `empleado_especialidad` DROP FOREIGN KEY `Empleado_Especialidad_idEmp_fkey`;

-- DropForeignKey
ALTER TABLE `empleado_especialidad` DROP FOREIGN KEY `Empleado_Especialidad_idEsp_fkey`;
...
ALTER TABLE `empleado` DROP COLUMN `createdAt`,
    ...
    MODIFY `estado` INTEGER NULL;

-- AlterTable
ALTER TABLE `empleado_especialidad` MODIFY `idEmp` INTEGER NULL,
    MODIFY `idEsp` INTEGER NULL;

-- AlterTable
ALTER TABLE `especialidad` MODIFY `especialidad` VARCHAR(30) NULL,
    MODIFY `estado` INTEGER NULL;
...
-- RedefineIndex
CREATE INDEX `idEmp` ON `empleado_especialidad`(`idEmp`);
DROP INDEX `Empleado_Especialidad_idEmp_fkey` ON `empleado_especialidad`;

-- RedefineIndex
CREATE INDEX `idEsp` ON `empleado_especialidad`(`idEsp`);
DROP INDEX `Empleado_Especialidad_idEsp_fkey` ON `empleado_especialidad`;
